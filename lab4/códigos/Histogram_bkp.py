...
histograma_antes_normalizado = histograma_antes / histograma_antes.sum()
...
histograma_depois_normalizado = histograma_depois / histograma_depois.sum()

# Exibir os gráficos de histograma antes e depois da equalização
plt.figure(figsize=(10, 5))
plt.subplot(1, 2, 1)
plt.plot(histograma_antes_normalizado)
plt.title('Histograma Antes da Equalização (Normalizado)')
plt.subplot(1, 2, 2)
plt.plot(histograma_depois_normalizado)
plt.title('Histograma Depois da Equalização (Normalizado)')
plt.show()
