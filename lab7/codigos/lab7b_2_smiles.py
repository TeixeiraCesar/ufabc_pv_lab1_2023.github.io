...
test_image = cv2.imread('todos.png')
# test_image = cv2.imread('GrupoAvatar.png')
...
smiles = smile_cascade.detectMultiScale(grey, 1.2, 20)
...
if cv2.waitKey(0) == ord('q'):
 cv2.imwrite('teste_all_todos_smiles_7b_2.png',test_image)
...
if cv2.waitKey(0) == ord('q'):
 cv2.imwrite('teste_Smiles_face_todos_7b_2.png',test_image)
