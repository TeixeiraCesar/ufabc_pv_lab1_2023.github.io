...
# Load the image
image_path = "transistor2.jpeg"
#image_path = "semNada.jpeg"
...
# Resize the image to a smaller size (you can adjust the dimensions)
...
# Create masks to segment blue and black objects
mask_blue = cv2.inRange(hsv_frame, lower_blue, upper_blue)
mask_black = cv2.inRange(hsv_frame, np.array([0, 0, 0]), np.array([180, 255, 30]))
...
# Find contours of blue and black objects in the segmented image
